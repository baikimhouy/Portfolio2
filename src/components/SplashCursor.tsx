...
class Program {
  ...
  constructor(gl: WebGL2RenderingContext | WebGLRenderingContext, vertexShader: WebGLShader | null, fragmentShader: WebGLShader | null, createProgram: (v: WebGLShader | null, f: WebGLShader | null) => WebGLProgram | null, getUniforms: (p: WebGLProgram) => Record<string, WebGLUniformLocation | null>) {
    this.gl = gl;
...
class Material {
  ...
  compileShader: (type: number, source: string, keywords?: string[] | null) => WebGLShader | null;
  createProgram: (v: WebGLShader | null, f: WebGLShader | null) => WebGLProgram | null;
  getUniforms: (p: WebGLProgram) => Record<string, WebGLUniformLocation | null>;

  constructor(gl: WebGL2RenderingContext | WebGLRenderingContext, vertexShader: WebGLShader | null, fragmentShaderSource: string, hashCode: (s: string) => number, compileShader: (type: number, source: string, keywords?: string[] | null) => WebGLShader | null, createProgram: (v: WebGLShader | null, f: WebGLShader | null) => WebGLProgram | null, getUniforms: (p: WebGLProgram) => Record<string, WebGLUniformLocation | null>) {
    this.gl = gl;
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement) {
      ...
      const halfFloatTexType = isWebGL2
        ...
        : (halfFloat && ('HALF_FLOAT_OES' in halfFloat ? halfFloat.HALF_FLOAT_OES : 0)) || 0;
    ...
    const gradienSubtractProgram = new Program(gl, baseVertexShader, gradientSubtractShader, createProgram, getUniforms);
    const displayMaterial = new Material(gl, baseVertexShader, displayShaderSource, hashCode, compileShader, createProgram, getUniforms);
